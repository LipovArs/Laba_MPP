...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference("Specialization.count") do
      post specializations_url, params: { specialization: { content: @specialization.content, name: @specialization.name, title: @specialization.title } }
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { content: @specialization.content, name: @specialization.name, title: @specialization.title } }
